...
> **文档定位纠偏（2026-08-21）**：本文只记录早期 TTRPG 事件与规则内核，不再代表完整跑团产品已经交付。
> 固定场景、手工工作台和单一规则只能用于内核测试。世界到跑团生产、席位/完整车卡、RulePack V2、村规、
> 真人/AI 混合桌、可信 AI KP、信息隔离和运行时媒资以
> [`TTRPG 完整跑团产品施工总方案 V2`](./ttrpg/TTRPG-COMPLETE-PRODUCT-CONSTRUCTION-PLAN-V2.md) 为唯一权威。

> 状态：TTRPG-1A/1B/1C 早期事件与规则内核已交付；完整跑团产品未交付（2026-08-21 复核）
> 主归属：TTRPG-1 跑团与战役主持
