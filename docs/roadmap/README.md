...
| 4 | **WORLD-1 世界知识、词条、地图与修炼** | 把散文设定升级成可关联、可计算、可供创作和运行时共用的知识库 | Codex 世界隔离、Phase 37-a、Phase 34 与 Phase 35-b 已完成；继续 Phase 35-c 导入分类、`ENH-WORLDMAP-2` | Codex/自然/人文无重复入口；地点、势力、物产、器物、修炼和力量阶段引用一致 | **IN PROGRESS；下一步 Phase 35-c 导入分类** |
