...
| 4 | **WORLD-1 世界知识、词条、地图与修炼** | 把散文设定升级成可关联、可计算、可供创作和运行时共用的知识库 | Codex 世界隔离地基与 Phase 37-a 已完成；继续 Phase 34、Phase 35-b/c 收口、`ENH-WORLDMAP-2`、历史线归并 | Codex/自然/人文无重复入口；地点、势力、物产、器物、修炼和力量阶段引用一致 | **IN PROGRESS；下一步 Phase 34 下游进度** |
...
5. 🔄 WORLD-1：✅ 世界隔离地基 → ✅ Phase 37-a 修炼体系 → Phase 34 力量追踪 → 分类/历史/地图剩余收口。
...
- 项目/世界删除、单世界转多世界盖章、v41 空迁移、阶段/体系删除、角色/异兽引用以及全部 FK 导出导入均有回归测试。Phase 34 逐章进度仍是下一阶段，不把角色卡设定冒充下游事实。
