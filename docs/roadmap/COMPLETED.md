...
| **AGENT-1 当前阶段** | Phase 16/17 工作流；模型路由；Phase 27.1-a/b/c；Phase 27.2a 场景考证 | Prompt workflow、任务模型路由、13 个受作用域/预算约束的只读工具、严格协议只读 AgentRunner、世界来源 ChatCopilot 可编辑确认闭环、用户触发的场景考证 | `R-AGENT1-*`、`AGENT-TOOL-REGISTRY-DESIGN.md`、`AGENT-RUNNER-DESIGN.md`、`CHAT-COPILOT-MVP-DESIGN.md`、`AI-COPILOT-DESIGN.md` |
