...
| **WORLD-1 世界知识** | Phase 20/22/23/25/32；C-1/C-2/C-6/C-7；Phase 36；多世界 25.4/25.5；WORLD-1 世界隔离地基；Phase 37-a；Phase 34；Phase 35-b | Codex、重要地点、地图、世界规则、多世界、正式历史、严格世界隔离、修炼体系 DAG、正文修炼进度、政经文化拆分、城池地点软关联和旧资料无损兼容 | `R-PHASE36-content-types`、`cultivation-system.test.ts`、`cultivation-progress.test.ts`、`R-WORLD1-*`、Codex/location 回归、浏览器世界知识归并流程 |
...
- Phase 37-a 与 Phase 34 已完成；Phase 35 剩余分类/历史/地图收口未完成。
