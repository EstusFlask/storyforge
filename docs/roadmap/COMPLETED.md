...
| **FLOW-1 节点模式** | FLOW-1 第一阶段 | 旧工作流兼容图、可持久化 DAG、画布与端口、稳定拓扑执行、显式入边装配、后序候选失效、作者确认式作品写回 | `R-FLOW1-*`、`R-WF-workflow-step-context`、Chromium 节点模式闭环、`VISUAL-WORKFLOW-DESIGN.md` |
