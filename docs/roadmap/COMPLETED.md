...
| **WORLD-1 世界知识** | Phase 20/22/23/25/32；C-1/C-2/C-6/C-7；Phase 36；多世界 25.4/25.5；WORLD-1 世界隔离地基；Phase 37-a | Codex、重要地点、地图、世界规则、多世界、历史年表、严格世界隔离、修炼体系 DAG、角色种族/主修/境界、异兽关联和上游 AI/Canon 注入 | `R-PHASE36-content-types`、`cultivation-system.test.ts`、`R-WORLD1-*`、Codex/location 回归 |
...
- Phase 37-a 已完成；Phase 34 逐章修炼进度和 Phase 35 剩余分类/历史/地图收口未完成。
