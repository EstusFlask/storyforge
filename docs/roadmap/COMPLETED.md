...
| **AUTHOR-1 作者工具** | Phase E/H；基础文风学习；编辑器基础；`CF-20260702-5/10/11`；`EDITOR-5` | 本地模型配置、任务路由、文风基础、富文本、自动保存、对照润色、稳定实体智能全书改名与原子撤销 | `R-EDITOR3-*`、`R-EDITOR5-entity-rename`、本地模型与任务路由回归 |
...
- `FB-4`、`FB-5` 高级校准、`CM-1` 未完成；`EDITOR-2/5` 已完成。
