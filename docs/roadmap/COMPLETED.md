...
| **WORLD-1 世界知识** | Phase 20/22/23/25/32；C-1/C-2/C-6/C-7；Phase 36；多世界 25.4/25.5；WORLD-1 世界隔离地基；Phase 37-a；Phase 34 | Codex、重要地点、地图、世界规则、多世界、历史年表、严格世界隔离、修炼体系 DAG、角色种族/主修/设定境界、异兽关联、正文修炼进度事件流和上游 AI/Canon 注入 | `R-PHASE36-content-types`、`cultivation-system.test.ts`、`cultivation-progress.test.ts`、`R-WORLD1-*`、Codex/location 回归 |
