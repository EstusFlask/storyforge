...
| TypeScript 生产源码 | 771 个文件 / 235578 行 | `tsconfig.json` |
| IndexedDB schema | v66 / 90 张 required tables | `schema.ts` / `REQUIRED_TABLES` |
| PROJECT_TABLES | 90 张表 | `project-tables.ts` |
