...
| TypeScript 生产源码 | 464 个文件 / 92081 行 | `tsconfig.json` |
| IndexedDB schema | v45 / 49 张 required tables | `schema.ts` / `REQUIRED_TABLES` |
| PROJECT_TABLES | 49 张表 | `project-tables.ts` |
