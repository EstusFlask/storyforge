...
| `chapter.memory` | `src/components/editor/ChapterEditor.tsx:1088` |
...
| `outline.chapter` | `src/lib/ai/batch-outline-runner.ts:184`<br/>`src/lib/outline/generation-node.ts:59` |
