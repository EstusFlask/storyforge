...
- 分步骤长篇、短篇、剧本和漫画是可独立成立的创作产品；
- 节点模式是同一长篇生产链的可视、可组合表达；
...
| 领域 | 状态 | 说明 |
|---|---|---|
| 分步骤长篇 | 部分可用、主要入口 | 世界观、故事、角色、大纲、细纲、正文和多种长期一致性设施已存在；仍需完成全链统一、真实长期创作和百万字验证 |
...
| 世界引擎 | 部分实现 | 有世界编号、投影、完整度、release/分享基础；统一版本化数据出口和独立作品边界需纠正 |
...
[总纲对齐审计](./docs/audits/PROJECT-CHARTER-ALIGNMENT-AUDIT-20260826.md)。
...
模型结果先成为候选，作者确认后才进入正式作品。刷新恢复、stale 阻断、Context Gateway、原文回查和持久化 run 共同服务长篇一致性。百万字是目标上限；当前存在合成规模工程门，但真实百万字作者项目与文学一致性还没有被宣称完成。
