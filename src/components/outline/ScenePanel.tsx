...
export default function ScenePanel({ project, outlineNodeId, chapterTitle, chapterSummary }: Props) {
  ...
  const handleAIGenerate = async () => {
    const assembled = await assembleContext({
      ...
      worldGroupId: null,
      outlineNodeId,
      sourceKeys: ['chapterOutline', 'canonAssertions', 'worldview', 'storyCore', 'powerSystem', 'cultivationProgress', 'codex', 'characters', 'creativeRules', 'worldRules', 'historical', 'locations'],
    })
