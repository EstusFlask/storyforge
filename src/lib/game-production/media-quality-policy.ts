import type { GameRuntimePackageV2 } from '../types'

export const GAME_COMMERCIAL_MEDIA_POLICY_V2 = Object.freeze({
  policyId: 'storyforge.game-media-commercial.v2',
  policyVersion: '2',
...
export interface GameMediaQualityProbeV2 {
  assetKey: string
...
export function evaluateGameMediaCommercialPolicyV2(input: {
  runtimePackage: GameRuntimePackageV2
  probe: GameMediaQualityProbeV2
}): string[] {
  const policy = GAME_COMMERCIAL_MEDIA_POLICY_V2
