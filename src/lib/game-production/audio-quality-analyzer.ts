export interface DecodedGameAudioPcmV1 {
  channels: Float32Array[]
  sampleRateHz: number
}

export interface GameAudioQualityAnalysisV1 {
  channelCount: number
  sampleRateHz: number
  durationMs: number
 ...
 */
export function analyzeDecodedGameAudioPcmV1(input: DecodedGameAudioPcmV1): GameAudioQualityAnalysisV1 {
