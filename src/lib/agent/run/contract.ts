...
export function parseAgentRunContractV1(value: unknown): AgentRunContractV1 {
  ...
  assertExactKeys(
    record,
    ['version', 'objective', 'workflowKind', 'ownership', 'lineage', 'scope', 'permissions', 'runtimeBindingHash', 'executionBindings', 'dependencyReceiptPolicy', 'candidateSemanticReviewPolicy', 'budget', 'acceptance', 'verificationPlan', 'failurePolicy'],
