...
import type {
  DomainOwnershipSpec,
  TableSpec,
  WorkspaceMemoryClassificationV1,
} from "./types";

const WORKSPACE_DOMAIN_OWNER = {
  allowed: ["workspace"],
  legacyDefault: "workspace",
...
const LEGACY_WORLD_OWNER = {
  allowed: ["world"],
  legacyDefault: "world",
  locator: { kind: "field", owner: "world", field: "worldId" },
} as const satisfies DomainOwnershipSpec;

const LEGACY_WORK_OWNER = {
  allowed: ["work"],
  legacyDefault: "work",
  locator: { kind: "field", owner: "work", field: "workId" },
} as const satisfies DomainOwnershipSpec;
...
type ProjectTableRegistration = Omit<TableSpec, "memoryClassification"> & {
  /** Explicit policy for governed data that is editable without a filesystem document projection. */
...
const PROJECT_TABLE_REGISTRATIONS: ProjectTableRegistration[] = [
  // ───────────────────────── 项目根表 ─────────────────────────
  {
    ...
    workspaceProjection: {
      ...
      mapper: "workspace-root-v1",
      codec: "json",
      editPolicy: "author-editable",
      scopeOwner: "workspace",
      dependencyEmitter: "workspace-root-impact-v1",
      schemaVersion: 1,
    },
    exportRemap: [
      {
      ...
      },
      {
        field: "activeWorldId",
        remapVia: "worlds",
        exportAs: "_activeWorldExportId",
      },
      {
        field: "activeWorkId",
        remapVia: "works",
        exportAs: "_activeWorkExportId",
      },
    ],
  ...
  // WORLD-2C C1 added empty roots; C2 now creates/adopts them lazily on workspace entry.
  {
    ...
    workspaceProjection: {
      ...
      classification: "editable",
      documentKind: "world",
      mapper: "world-root-v1",
      codec: "yaml",
      editPolicy: "author-editable",
      scopeOwner: "world",
      dependencyEmitter: "world-root-impact-v1",
      schemaVersion: 1,
    },
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "works[worldId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "worldRevisions[worldId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "worldReleases[worldId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameDefinitions[worldId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameReleases[worldId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameRulePacks[worldId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "ttrpgCampaignModules[worldId]",
        onDelete: "cascade",
      },
      ...[
        "ttrpgProductions",
        ...
        field: "id",
        target: `${target}[worldId]`,
        onDelete: "cascade" as const,
      })),
      {
        kind: "simple",
        field: "id",
        target: "gameProductions[worldId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameProductionBriefs[worldId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameProductionCommands[worldId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameBuilds[worldId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameBuildArtifacts[worldId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameQualityGateReceipts[worldId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "mediaBlobObjects[worldId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "simulationSessions[worldId]",
        onDelete: "cascade",
      },
    ],
...

  {
    ...
    workspaceProjection: {
      ...
      editPolicy: "author-editable",
      scopeOwner: "work",
      dependencyEmitter: "work-root-impact-v1",
      schemaVersion: 1,
    },
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "workCharacterBindings[workId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameDefinitions[workId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameReleases[workId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameRulePacks[workId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "ttrpgCampaignModules[workId]",
        onDelete: "cascade",
      },
      ...[
        "ttrpgProductions",
      ...
      })),
      {
        kind: "simple",
        field: "id",
        target: "gameProductions[workId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameProductionBriefs[workId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameProductionCommands[workId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameBuilds[workId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameBuildArtifacts[workId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameQualityGateReceipts[workId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "mediaBlobObjects[workId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "simulationSessions[workId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "agentRuns[workId]",
        onDelete: "cascade",
      },
    ],
    exportRemap: [
      ...
      {
        field: "activeNarrativeModuleId",
        remapVia: "narrativeModules",
  ...
  {
    table: db.workCharacterBindings,
    name: "workCharacterBindings",
    owner: "project",
    exportable: true,
    communityShare: "world",
    releaseSection: "characters",
    domainOwner: {
      allowed: ["work"],
      legacyDefault: "work",
      locator: { kind: "field", owner: "work", field: "workId" },
  ...
  {
    table: db.ownershipMigrations,
    name: "ownershipMigrations",
    owner: "transient",
    exportable: false,
    domainOwner: WORKSPACE_DOMAIN_OWNER,
    ...
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "worldReleases[revisionId]",
        onDelete: "keep",
      },
    ],
    exportRemap: [
...

  {
    ...
    worldDomains: ["foundation", "narrative"],
    communityShare: "world",
    releaseSection: "foundation",
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "gameReleases[worldReleaseId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "ttrpgCampaignModules[sourceWorldReleaseId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "ttrpgSourceSelections[sourceWorldReleaseId]",
        onDelete: "setNull",
      },
      {
        kind: "simple",
        field: "id",
        target: "ttrpgProductReleases[sourceWorldReleaseId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "characterInteractionSourceSelections[sourceWorldReleaseId]",
        onDelete: "cascade",
      },
    ],
    exportRemap: [
...

  {
    ...
    exportable: true,
    communityShare: "world",
    releaseSection: "narrative",
    domainOwner: LEGACY_WORK_OWNER,
    workspaceProjection: {
      version: 1,
      classification: "editable",
      documentKind: "story-core",
      mapper: "work-semantic-v1",
      codec: "yaml",
      editPolicy: "author-editable",
      scopeOwner: "work",
      dependencyEmitter: "work-semantic-impact-v1",
      schemaVersion: 1,
    },
    ...
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "characters[cultivationSystemId]",
        onDelete: "setNull",
      },
      {
        kind: "simple",
        field: "id",
        target: "codexEntries[cultivationSystemId]",
        onDelete: "setNull",
      },
      {
        kind: "simple",
        field: "id",
        target: "temporalFacts[sourceCultivationSystemId]",
        onDelete: "setNull",
      },
      {
        kind: "simple",
        field: "id",
        target: "cultivationProgress[cultivationSystemId]",
        onDelete: "setNull",
      },
    ],
    exportRemap: [
...

  {
    ...
    exportRemap: [
      ...
      {
        field: "cultivationSystemId",
        remapVia: "cultivationSystems",
        exportAs: "_cultivationSystemExportId",
      },
      {
        field: "sourceChapterId",
        remapVia: "chapters",
        exportAs: "_sourceChapterExportId",
      },
    ],
    ...
    refs: [
      {
        kind: "json",
        field: "portalsJSON",
        jsonPath: "$[].targetWorldId",
        target: "worldNodes[id]",
        onDelete: "remap",
      },
    ],
    exportRemap: [
  ...
  {
    table: db.historicalTimelineEvents,
    name: "historicalTimelineEvents",
    owner: "project",
    domainOwner: LEGACY_WORLD_OWNER,
    worldScoped: true,
    exportable: true,
  ...
  {
    table: db.historicalKeywords,
    name: "historicalKeywords",
    owner: "project",
    domainOwner: LEGACY_WORLD_OWNER,
    worldScoped: true,
    exportable: true,
    ...
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "codexEntries[importantLocationId]",
        onDelete: "setNull",
      },
    ],
    exportRemap: [
  ...
  {
    table: db.worldRulesProfiles,
    name: "worldRulesProfiles",
    owner: "project",
    domainOwner: LEGACY_WORLD_OWNER,
    worldScoped: true,
    exportable: true,
  ...
  // ───────────────────── 角色 ─────────────────────
  {
    ...
    refs: [
      ...
      },
      {
        kind: "simple",
        field: "id",
        target: "characterRelations[toCharacterId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "chapters[perspectiveCharacterId]",
        onDelete: "setNull",
      },
      {
        kind: "simple",
        field: "id",
        target: "narrativeBeats[speakerCharacterId]",
        onDelete: "setNull",
      },
      {
        kind: "simple",
        field: "id",
        target: "interactionCharacterProfiles[characterId]",
        onDelete: "cascade",
      },
      {
        kind: "array",
        field: "appearingCharacterIds",
        itemTarget: "detailedOutlines",
        onDelete: "removeItem",
      },
    ],
    exportRemap: [
      {
        field: "homeWorldGroupId",
        remapVia: "worldGroups",
        exportAs: "_homeWorldGroupExportId",
      },
      {
        field: "raceEntryId",
        remapVia: "codexEntries",
        exportAs: "_raceEntryExportId",
      },
      {
        field: "cultivationSystemId",
        remapVia: "cultivationSystems",
    ...
    exportRemap: [
      {
        ...
        remapVia: "characters",
        exportAs: "_fromCharacterIndex",
        onUnmapped: "drop",
      },
      {
        field: "toCharacterId",
        remapVia: "characters",
        exportAs: "_toCharacterIndex",
        onUnmapped: "drop",
      },
    ],
  },
    ...
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "chapters[outlineNodeId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "detailedOutlines[outlineNodeId]",
        onDelete: "cascade",
      },
    ],
    exportRemap: [
...

  {
    ...
    workspaceProjection: {
      ...
      mapper: "chapter-markdown-v1",
      codec: "markdown-frontmatter",
      editPolicy: "author-editable",
      scopeOwner: "work",
      dependencyEmitter: "chapter-impact-v1",
      schemaVersion: 1,
    },
    selfIdPaths: [
      "continuityHandoff.chapterId",
      "planReconciliation.chapterId",
    ],
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "emotionBeatCards[chapterId]",
        onDelete: "cascade",
      },
    ...
    exportRemap: [
      {
        field: "outlineNodeId",
        remapVia: "outlineNodes",
        exportAs: "_outlineExportId",
        onUnmapped: "require",
      },
      {
        field: "perspectiveCharacterId",
        remapVia: "characters",
        exportAs: "_perspectiveCharacterExportId",
      },
    ],
  },

  {
    table: db.detailedOutlines,
    name: "detailedOutlines",
    owner: "project",
    exportable: true,
    domainOwner: LEGACY_WORLD_OR_WORK_OWNER,
    communityShare: "world",
    ...
    exportRefRemap: [
      {
        ...
        remapVia: "characters",
        kind: "id-array",
        exportAs: "_appearingCharacterIndexes",
      },
      {
        field: "foreshadowIds",
        remapVia: "foreshadows",
        kind: "id-array",
        exportAs: "_foreshadowIndexes",
      },
      {
        field: "scenes",
        remapVia: "characters",
        kind: "scene-character-ids",
        exportAs: "_sceneCharacterIndexes",
      },
    ],
    exportRemap: [
      {
  ...
  {
    table: db.emotionBeatCards,
    name: "emotionBeatCards",
    owner: "project",
    exportable: true,
    domainOwner: LEGACY_WORK_OWNER,
    exportRemap: [
    ...
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "storylineProgress[arcId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "storylineCrossings[arcIdA]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "storylineCrossings[arcIdB]",
        onDelete: "cascade",
      },
    ],
  },
  ...
  {
    table: db.narrativeModules,
    name: "narrativeModules",
    owner: "project",
    exportable: true,
    exportIdField: true,
    domainOwner: LEGACY_WORLD_OR_WORK_OWNER,
    ...
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "narrativeNodes[moduleId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "narrativeBeats[moduleId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "narrativeChoices[moduleId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "gameDefinitions[narrativeModuleId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "works[activeNarrativeModuleId]",
        onDelete: "setNull",
      },
      {
        kind: "simple",
        field: "id",
        target: "simulationSessions[narrativeModuleId]",
        onDelete: "setNull",
      },
    ],
    defaults: {
    ...
    exportRemap: [
      {
        field: "moduleId",
        remapVia: "narrativeModules",
        exportAs: "_moduleExportId",
        onUnmapped: "require",
      },
      {
        field: "sourceOutlineNodeId",
        remapVia: "outlineNodes",
        exportAs: "_sourceOutlineExportId",
      },
    ],
    defaults: {
      summary: "",
...

  {
    ...
    exportRemap: [
      ...
      },
      {
        ...
        remapVia: "characters",
        exportAs: "_speakerCharacterExportId",
      },
    ],
  ...
  {
    table: db.narrativeChoices,
    name: "narrativeChoices",
    owner: "project",
    exportable: true,
    exportIdField: true,
    domainOwner: {
    ...
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "gameReleases[gameDefinitionId]",
        onDelete: "setNull",
      },
      {
        kind: "simple",
        field: "id",
        target: "interactionCharacterProfiles[gameDefinitionId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "interactionSceneTemplates[gameDefinitionId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "adventureModules[gameDefinitionId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "avgPresentationModules[gameDefinitionId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "narrativeSimulationModules[gameDefinitionId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "openWorldModules[gameDefinitionId]",
        onDelete: "cascade",
      },
    ],
    exportRemap: [
      ...
      {
        field: "narrativeModuleId",
        remapVia: "narrativeModules",
        exportAs: "_narrativeModuleExportId",
        onUnmapped: "require",
      },
    ],
    defaults: {
  ...
  {
    table: db.interactionCharacterProfiles,
    name: "interactionCharacterProfiles",
    owner: "project",
    exportable: true,
    exportIdField: true,
    domainOwner: {
    ...
    exportRemap: [
      ...
      {
        field: "gameDefinitionId",
        remapVia: "gameDefinitions",
        exportAs: "_gameDefinitionExportId",
        onUnmapped: "require",
      },
      {
        field: "characterId",
  ...
  {
    table: db.interactionSceneTemplates,
    name: "interactionSceneTemplates",
    owner: "project",
    exportable: true,
    exportIdField: true,
    domainOwner: {
    ...
    defaults: {
      ...
      timeLabel: "",
      participantKeysJson: "[]",
      publicKnowledgeKeysJson: "[]",
      goalsJson: "[]",
      endingConditionsJson: "[]",
      safetyBoundariesJson: "[]",
  ...
  {
    table: db.adventureModules,
    name: "adventureModules",
    owner: "project",
    exportable: true,
    exportIdField: true,
    domainOwner: {
    ...
    defaults: {
      contentJson:
        '{"version":1,"initialLocationKey":"","playerKey":"player","locations":[],"objects":[],"items":[],"abilities":[],"conditions":[],"resources":[],"quests":[],"actions":[],"initialInventory":[]}',
    },
    note: "TEXTADV-1 作者内容模块；内部引用仅用稳定 key，运行进度由 SIM 事件拥有",
  },

  {
    table: db.avgMediaAssets,
    name: "avgMediaAssets",
    owner: "project",
    exportable: true,
    exportIdField: true,
    ...
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "avgMediaBlobs[mediaAssetId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "ttrpgRuntimeAssetRequests[mediaAssetId]",
        onDelete: "setNull",
      },
    ],
    exportRemap: [
...

  {
    ...
    portableData: {
      ...
      field: "data",
      allowMissingWhen: {
        exportField: "_blobObjectExportId",
        importField: "blobObjectId",
      },
      integrity: {
        metadataTable: "avgMediaAssets",
        referenceField: "mediaAssetId",
  ...
  {
    table: db.avgPresentationModules,
    name: "avgPresentationModules",
    owner: "project",
    exportable: true,
    exportIdField: true,
    domainOwner: {
  ...
  {
    table: db.narrativeSimulationModules,
    name: "narrativeSimulationModules",
    owner: "project",
    exportable: true,
    exportIdField: true,
    domainOwner: {
    ...
    defaults: {
      contentJson:
        '{"version":1,"turnLimit":30,"actionBudget":1,"resources":[],"metrics":[],"actors":[],"actions":[],"modifiers":[],"issues":[],"endings":[],"themes":[]}',
    },
    note: "TEXTSIM-1 作者规则模块；运行投影与长期后果只由共享 SIM 事件拥有",
  },

  {
    table: db.openWorldModules,
    name: "openWorldModules",
    owner: "project",
    exportable: true,
    exportIdField: true,
    domainOwner: {
  ...
  // ───────────────────── TTRPG-2A declarative product authoring ─────────────────────
  {
  ...
  // ───────────────────── TTRPG-4B product-owned production lineage ─────────────────────
  {
    ...
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "simulationSessions[gameReleaseId]",
        onDelete: "setNull",
      },
    ],
    exportRemap: [
      ...
      {
        field: "worldReleaseId",
        remapVia: "worldReleases",
        exportAs: "_worldReleaseExportId",
        onUnmapped: "require",
      },
    ],
  ...
  {
    table: db.mediaBlobObjects,
    name: "mediaBlobObjects",
    owner: "project",
    exportable: true,
    exportIdField: true,
    domainOwner: LEGACY_WORK_OWNER,
    ...
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "gameBuildArtifacts[blobObjectId]",
        onDelete: "keep",
      },
      {
        kind: "simple",
        field: "id",
        target: "avgMediaBlobs[blobObjectId]",
        onDelete: "keep",
      },
      {
        kind: "simple",
        field: "id",
        target: "ttrpgProductionMediaAssets[blobObjectId]",
        onDelete: "keep",
      },
    ],
    exportRemap: [
    ...
    portableData: {
      ...
      stateField: "storageState",
      pathField: "opfsPath",
      leaseOwnerField: "leaseOwner",
      leaseExpiresAtField: "leaseExpiresAt",
    ...
    memoryClassification: {
      ...
      reason:
        "共享二进制随 recovery capsule 便携，但不镜像成可编辑工作区文档。",
    },
    defaults: {
      backend: "indexeddb",
    ...
    note: "GAMEPROD-1 Work 内 content-addressed 共享媒资；物理删除只允许引用感知 GC",
  },
  ...
  {
    table: db.characterDrivenPlans,
    name: "characterDrivenPlans",
    owner: "project",
    domainOwner: LEGACY_WORK_OWNER,
    exportable: true,
    exportIdField: true,
    tree: { parentField: "parentPlanId" },
    refs: [
      {
        kind: "json",
        field: "arcs",
      ...
      },
      {
        kind: "simple",
        field: "id",
        target: "projects[activeCharacterDrivenPlanId]",
        onDelete: "setNull",
      },
      {
        kind: "simple",
        field: "id",
        target: "characterDrivenPlans[parentPlanId]",
        onDelete: "setNull",
      },
    ],
    exportRemap: [
  ...
  {
    table: db.storylineProgress,
    name: "storylineProgress",
    owner: "project",
    domainOwner: LEGACY_WORK_OWNER,
    exportable: true,
    ...
    exportRemap: [
      {
        field: "arcId",
        remapVia: "storyArcs",
        exportAs: "_arcExportId",
        onUnmapped: "require",
      },
      {
        field: "lastActiveChapterId",
        remapVia: "chapters",
        exportAs: "_lastChapterExportId",
      },
    ],
  ...
  {
    table: db.storylineCrossings,
    name: "storylineCrossings",
    owner: "project",
    domainOwner: LEGACY_WORK_OWNER,
    exportable: true,
    exportRemap: [
      {
        field: "arcIdA",
        remapVia: "storyArcs",
        exportAs: "_arcAExportId",
        onUnmapped: "require",
      },
      {
        field: "arcIdB",
        remapVia: "storyArcs",
        exportAs: "_arcBExportId",
        onUnmapped: "require",
      },
      {
        field: "chapterId",
  ...
  {
    table: db.storyTimelineEvents,
    name: "storyTimelineEvents",
    owner: "project",
    exportable: true,
    domainOwner: LEGACY_WORK_OWNER,
    exportRemap: [
...

  {
    ...
    refs: [
      {
        kind: "array",
        field: "citedReferenceIds",
        itemTarget: "references",
        onDelete: "removeItem",
      },
    ],
    exportRefRemap: [
      {
        ...
        remapVia: "references",
        kind: "id-array",
        exportAs: "_citedReferenceIndexes",
        storage: "json-string",
      },
    ],
  },
  ...
  // ───────────────────── 词条系统 ─────────────────────
  {
    table: db.codexCategories,
    name: "codexCategories",
    owner: "project",
    domainOwner: LEGACY_WORLD_OWNER,
    exportable: true,
    communityShare: "world",
    ...
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "codexEntries[categoryId]",
        onDelete: "cascade",
      },
    ],
    exportRemap: [
...

  {
    ...
    exportRemap: [
      ...
      {
        field: "importantLocationId",
        remapVia: "importantLocations",
        exportAs: "_importantLocationExportId",
      },
    ],
  },
  ...
  // ───────────────────── 增量灵感工作区（CM-1） ─────────────────────
  {
    table: db.inspirationWorkspaces,
    name: "inspirationWorkspaces",
    owner: "project",
    exportable: true,
    domainOwner: LEGACY_WORK_OWNER,
    ...
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "agentEvents[conversationId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "agentRuns[conversationId]",
        onDelete: "setNull",
      },
    ],
    exportRemap: [
    ...
    exportRemap: [
      {
        ...
        remapVia: "agentConversations",
        exportAs: "_conversationExportId",
        onUnmapped: "require",
      },
      {
        field: "durableRunId",
        remapVia: "agentRuns",
        exportAs: "_agentRunExportId",
      },
    ],
...

  {
    ...
    owner: "project",
    domainOwner: {
      allowed: ["work", "instance"],
      legacyDefault: "work",
      locator: {
        kind: "exclusive-work-instance",
        workField: "workId",
        instanceField: "simulationSessionId",
      },
    },
    worldScoped: true,
    exportable: true,
    ...
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "agentRuns[parentRunId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "agentRunEvents[runId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "agentRunCheckpoints[runId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "agentEvents[durableRunId]",
        onDelete: "setNull",
      },
    ],
    exportRemap: [
  ...
  {
    table: db.agentRunCheckpoints,
    name: "agentRunCheckpoints",
    owner: "project",
    domainOwner: {
      allowed: ["work", "instance"],
      legacyDefault: "work",
  ...
  // ───────────────────── SIM-1 共享互动运行时 ─────────────────────
  {
    table: db.simulationSessions,
    name: "simulationSessions",
    owner: "project",
    domainOwner: {
      allowed: ["instance"],
      legacyDefault: "instance",
      locator: { kind: "field", owner: "instance", field: "id" },
    },
    worldScoped: true,
    exportable: true,
    exportIdField: true,
    ...
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "simulationSessions[parentSessionId]",
        onDelete: "setNull",
      },
      {
        kind: "simple",
        field: "id",
        target: "simulationEvents[sessionId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "simulationCheckpoints[sessionId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "ttrpgSessionParticipants[sessionId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "ttrpgRuntimeAssetRequests[sessionId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "agentRuns[simulationSessionId]",
        onDelete: "cascade",
      },
    ],
    exportRemap: [
      ...
      {
        field: "ttrpgBuildId",
        remapVia: "ttrpgProductionBuilds",
        exportAs: "_ttrpgBuildExportId",
      },
      {
        field: "narrativeModuleId",
        remapVia: "narrativeModules",
    ...
    defaults: {
      ...
      initialStateJson:
        '{"version":1,"clock":0,"entities":{},"memories":[],"narratives":[],"ttrpg":null,"lastSequence":0}',
      gameReleaseId: null,
      gameBuildId: null,
      ttrpgBuildId: null,
  ...
  {
    table: db.simulationCheckpoints,
    name: "simulationCheckpoints",
    owner: "project",
    domainOwner: {
      allowed: ["instance"],
      legacyDefault: "instance",
    ...
    exportRemap: [
      {
        field: "worldGroupId",
        remapVia: "worldGroups",
        exportAs: "_wgExportId",
      },
      {
        field: "characterId",
        remapVia: "characters",
        exportAs: "_charExportId",
      },
      {
        field: "locationId",
        remapVia: "importantLocations",
        exportAs: "_locExportId",
      },
      { field: "storyArcId", remapVia: "storyArcs", exportAs: "_arcExportId" },
      {
        field: "subjectWorldGroupId",
        remapVia: "worldGroups",
        exportAs: "_subjWgExportId",
      },
      {
        field: "codexEntryId",
        remapVia: "codexEntries",
        exportAs: "_codexExportId",
      },
      {
        field: "objectCharacterId",
        remapVia: "characters",
        exportAs: "_objCharExportId",
      },
      {
        field: "objectLocationId",
        remapVia: "importantLocations",
        exportAs: "_objLocExportId",
      },
      {
        field: "objectCodexEntryId",
        remapVia: "codexEntries",
        exportAs: "_objCodexExportId",
      },
      {
        field: "sourceChapterId",
        remapVia: "chapters",
        exportAs: "_srcChapExportId",
      },
      {
        field: "sourceWorldviewId",
        remapVia: "worldviews",
        exportAs: "_srcWorldviewExportId",
      },
      {
        field: "sourcePowerSystemId",
        remapVia: "powerSystems",
        exportAs: "_srcPowerSystemExportId",
      },
      {
        field: "sourceCultivationSystemId",
        remapVia: "cultivationSystems",
        exportAs: "_srcCultivationSystemExportId",
      },
      {
        field: "sourceStoryCoreId",
        remapVia: "storyCores",
        exportAs: "_srcStoryCoreExportId",
      },
      {
        field: "sourceCharacterId",
        remapVia: "characters",
        exportAs: "_srcCharacterExportId",
      },
      {
        field: "validFromChapterId",
        remapVia: "chapters",
        exportAs: "_vFromChapExportId",
      },
      {
        field: "validToChapterId",
        remapVia: "chapters",
        exportAs: "_vToChapExportId",
      },
      {
        field: "supersedesFactId",
        remapVia: "temporalFacts",
        selfTree: true,
        exportAs: "_supersedesExportId",
      },
    ],
  ...
  {
    table: db.knowledgeLedger,
    name: "knowledgeLedger",
    owner: "project",
    worldScoped: true,
    domainOwner: LEGACY_WORK_OWNER,
    exportable: true,
  ...
  {
    table: db.narrativeSummaryNodes,
    name: "narrativeSummaryNodes",
    owner: "project",
    worldScoped: true,
    domainOwner: LEGACY_WORK_OWNER,
    exportable: false,
  ...
  {
    table: db.worldGroupLinks,
    name: "worldGroupLinks",
    owner: "project",
    exportable: true,
    communityShare: "world",
    releaseSection: "foundation",
    ...
    exportRemap: [
      {
        field: "fromGroupId",
        remapVia: "worldGroups",
        exportAs: "_fromGroupExportId",
        onUnmapped: "require",
      },
      {
        field: "toGroupId",
        remapVia: "worldGroups",
        exportAs: "_toGroupExportId",
        onUnmapped: "require",
      },
    ],
  },
    ...
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "referenceAnalysisRuns[referenceId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "referenceChunkAnalysis[referenceId]",
        onDelete: "cascade",
      },
    ],
  },
  ...
  {
    table: db.referenceAnalysisRuns,
    name: "referenceAnalysisRuns",
    owner: "project",
    domainOwner: LEGACY_WORK_OWNER,
    exportable: true,
    exportIdField: true,
    refs: [
      {
        kind: "simple",
        field: "id",
        target: "referenceChunkAnalysis[analysisRunId]",
        onDelete: "cascade",
      },
      {
        kind: "simple",
        field: "id",
        target: "referenceAnalysisSources[analysisRunId]",
        onDelete: "cascade",
      },
    ],
    exportRemap: [
  ...
  {
    table: db.referenceChunkAnalysis,
    name: "referenceChunkAnalysis",
    owner: "direct-child",
    domainOwner: LEGACY_WORK_OWNER,
    exportable: true,
    ...
    exportRemap: [
      ...
      {
        field: "analysisRunId",
        remapVia: "referenceAnalysisRuns",
        exportAs: "_analysisRunExportId",
      },
    ],
  },

  {
    table: db.referenceAnalysisSources,
    name: "referenceAnalysisSources",
    owner: "indirect",
    domainOwner: LEGACY_WORK_OWNER,
    exportable: false,
    projectResolver: async (projectId) =>
      (await db.referenceAnalysisRuns
        .where("projectId")
        .equals(projectId)
        .primaryKeys()) as number[],
    refs: [
  ...
  {
    table: db.promptWorkflows,
    name: "promptWorkflows",
    owner: "global",
    exportable: false,
  },
...
function classifyWorkspaceMemory(
  spec: ProjectTableRegistration,
): WorkspaceMemoryClassificationV1 {
  ...
  if (spec.exportable) {
    return {
      ...
      mirrorPolicy: "recovery-evidence",
      reason:
        "确定内容进入注册表派生 recovery capsule；磁盘副本只读并可完整恢复。",
    };
  }
  return {
    version: 1,
    ...
    mirrorPolicy: "rebuild-or-local-only",
    reason:
      "缓存、统计、临时事务或本地句柄不构成可移植项目记忆；由正式来源重建或留在本机。",
  };
}
 ...
 */
export const PROJECT_TABLES: TableSpec[] = PROJECT_TABLE_REGISTRATIONS.map(
  (spec) => ({
    ...spec,
