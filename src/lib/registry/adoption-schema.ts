...
export const ADOPTION_EXTENSIONS: readonly AdoptionExtensionSpec[] = Object.freeze([
  ...
  },
  {
    ...
    policyRegistry: 'PROJECT_TABLES portable binary + GAME_PRODUCTION_MEDIA_OBJECT_POLICY + SHA-256/MIME/dimension checks + lease/reference-aware GC',
  ...
  },
  {
    ...
    target: 'outlineNodes',
    entrypoints: ['src/lib/world-engine/create-workspace.ts'],
