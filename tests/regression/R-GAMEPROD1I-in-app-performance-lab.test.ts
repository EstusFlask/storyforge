...
import { collectBrowserPerformanceSamplesV1 } from '../../src/lib/game-production/in-app-browser-performance-lab'

describe('R-GAMEPROD-1I · in-app browser performance lab', () => {
