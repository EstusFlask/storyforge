...
import { shouldAutoContinueGameProductionV1 } from '../../src/components/text-game/GameProductionStudio'

describe('R-GAMEPROD-1D · durable author start command', () => {
  it('刷新或切页后仍会从 authorized/building checkpoint 自动续跑', () => {
    expect(shouldAutoContinueGameProductionV1({
